      ...
      <div className="card-premium group">
        <div className="relative h-64 overflow-hidden">
          ...
          <div className="absolute bottom-5 left-5 bg-white/90 dark:bg-secondary-900/90 backdrop-blur-md px-4 py-1.5 rounded-xl text-xs font-black uppercase tracking-widest text-secondary-900 dark:text-primary-400 shadow-soft">
            {typeof item.categoryId === 'object' ? item.categoryId?.name : 'General'}
          </div>
        </div>
        ...
        <div className="p-5 md:p-7 space-y-4 md:space-y-5">
          <div className="space-y-1">
            ...
            <div className="flex items-center justify-between">
              <p className="text-base md:text-lg font-black text-primary-500">Rs. {item.price}</p>
              <button 
                onClick={handleAddToCartClick}
                className="bg-primary-500 hover:bg-primary-600 text-white p-2.5 rounded-xl hover:scale-105 active:scale-95 transition-all shadow-soft dark:shadow-glow"
                title="Add to Cart"
              >
